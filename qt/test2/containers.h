...
public:
   ...
   char * Buf() {return buffer;};                // Access to buffer
...
private:
   ...
   char * buffer;                                // Buffer containing binary data. To be modified only by SetSize and operator >>
...
public:
   ...
   uint32_t GetBufSize() {return DataSize;}
